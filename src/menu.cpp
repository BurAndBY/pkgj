...
static const MenuEntry menu_entries[] = {
        ...
        {MenuFilter, "Только установленные игры", DbFilterInstalled},

        {MenuRefresh, "Обновление списка игр", 0},

        {MenuShow, "Показать Игры", 1},
        {MenuShow, "Показывать DLC", 2},
        {MenuShow, "Показывать демоверсии", 64},
        {MenuShow, "Показывать темы", 32},
        {MenuShow, "Показывать PS1 Показывать", 4},
        {MenuShow, "Показывать PSP игры", 8},
        {MenuShow, "Показывать PSP DLCs", 128},
        {MenuShow, "Показывать PSM игры", 16},
};
